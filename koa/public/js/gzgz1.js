(function(){	
    ...
    gzgz.prototype = {
	    initialize: function(item) {	    	
	    	...
	    	$('body').find('.wangwang').each(function(){	    			
			    	__put(this,true);
	...
	var preCreatSubDiv = function(item,container,type){
		...
		_unit.gzindex = container.gzindex;
		__put(_unit);
